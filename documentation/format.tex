...
% define command for HIPAcc acronym
\newcommand\hipacc{\mbox{\textsf{HIPA\hspace{-0.1em}\textsuperscript{cc}}}}
...
\lstset{%
    ...
    keywords={[4]Image,Accessor,AccessorNN,AccessorLF,AccessorBF,AccessorL3,Kernel,IterationSpace,Mask,BoundaryCondition,GlobalReduction,SUM,BOUNDARY_CLAMP,BOUNDARY_MIRROR},
